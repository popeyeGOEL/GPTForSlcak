...
from slack.ai_ops import (
    get_answer,
    write_answer,
    consume_custom_stream_to_write_reply,
...
from slack.utils import redact_string
...
TIMEOUT_ERROR_MESSAGE = (
    f":warning: Sorry! It looks like AI didn't respond within {AI_TIMEOUT_SECONDS} seconds. "
            ...
            messages.append(
                {
                    "role": "user",
                    "content": f"<@{user_id}>: "
                    + format_ai_message_content(msg_text, TRANSLATE_MARKDOWN),
                }
            )
            ...
            messages.append(
                {
                    ...
                    + format_ai_message_content(reply_text, TRANSLATE_MARKDOWN),
                    "role": "user",
                }
            )
